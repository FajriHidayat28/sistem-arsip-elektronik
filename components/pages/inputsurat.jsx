      ...
      {session && session.user.role === "ADMIN" ? (
        <div>
          <div className="flex flex-col md:flex-row gap-3">
            <CardMonitoring title={"Jumlah Berkas"} className="border-blue-500 basis-1/2" content={letters?.length} footer={"Jumlah berkas terupload : " + letters?.length} />
          ...
          <div className="card mt-3">
            <div className="flex gap-5">
              <div>
                <i className="fa-regular fa-circle-down text-green-500"></i> Surat Masuk
              </div>
              <div>
            ...
            <DataLists
              ...
              filterFields={["filenumber", "name", "filename"]}
              tableOptions={{
                rows: 10,
              }}
              columns={[
        ...
        <>
         ...
         {isLoading && (
            ...
            <div className="mx-auto mb-3 flex flex-col gap-1 w-[700px]">
              <div>
                <i className="fa-solid fa-spinner animate-spin"></i> Mengunggah...
              </div>
              <div className="mt-4 w-full bg-gray-200 rounded-full">
                <div className="bg-blue-600 rounded-full transition-all text-xs text-white text-center" style={{ width: `${progress}%` }}>
                  {progress}%
                </div>
              </div>
            </div>
          ...
          <div className="card flex flex-col gap-3 w-[700px] mx-auto">
            ...
            <form onSubmit={handleInputFile} className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                <label>Masukkan Nomor Surat</label>
              ...
              <div className="flex flex-col md:flex-row gap-3">
                <div className="flex flex-col gap-1 basis-1/2">
                  <label>Masukkan Perihal</label>
                  <input type="text" placeholder="Masukkan Perihal" value={filename} onChange={(e) => setFilename(e.target.value)} />
                </div>
                <div className="flex flex-col gap-1 basis-1/2">
