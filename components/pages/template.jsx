		...
		<div className="relative w-full h-screen flex">
			...
			>
				...
				<div className="flex flex-col gap-3 mt-3">
					<a href="/dashboard" className={activeClass("/dashboard")}>
					...
					{session?.user?.role === "ADMIN" ? (
						<>
							<a href="/dashboard/users" className={activeClass("/dashboard/users")}>
								<div className="w-12 text-center">
									<i className="fa-solid fa-users"></i>
								</div>
								Pengguna
							</a>
							<a href="/dashboard/register" className={activeClass("/dashboard/register")}>
								<div className="w-12 text-center">
						...
						<>
							<a
								href="/dashboard/input-surat"
								className={activeClass("/dashboard/input-surat")}
							>
								<div className="w-12 text-center">
							...
							<a
								...
								className={activeClass("/dashboard/letter-in")}
							>
								<div className="w-12 text-center">
							...
							<a
								...
								className={activeClass("/dashboard/letter-out")}
							>
								<div className="w-12 text-center">
