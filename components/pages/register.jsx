	...
	const handleRegister = async (e) => {
		...
		if (
			...
			toastAlert(
				"error",
				"Username Error!",
				"Username minimal 6 karakter, dan maksimal 12 karakter!",
				5000
			);
			setIsLoading(false);
			...
			toastAlert(
				"error",
				"Password Error!",
				"Kata Sandi minimal 6 karakter, dan maksimal 8 karakter!",
				5000
			);
			setIsLoading(false);
		} else {
	...
	return (
		<div className="card flex flex-col gap-3 w-[700px] mx-auto">
			...
			<form onSubmit={handleRegister} className="flex flex-col gap-3">
				...
				<button
					type="submit"
					className={`bg-blue-500 text-white rounded-lg p-3 hover:bg-blue-400 duration-500 ease-in-out ${isLoading ? "bg-blue-400 disabled" : ""
						}`}
					disabled={isLoading}
				>
					{isLoading ? (
